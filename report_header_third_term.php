...
$content="";
$content .= '<table  style="width:1000px; border-collapse: collapse" ><tr ><td class="banner" style="width:200px"><img style="width:160px" src="' . $woocommerce_gift_coupon_logo_base64 . '"></td><td class="banner" style="width:550px;padding-left:50px" align="left"><h1>SAINT JOHN PAUL II COLLEGE</h1><h2 align="center">SHELTER AFRIQUE, UYO</h2><h3 align="center">THIRD TERM 2021/2022 ACADEMIC SESSION</h3><h4 align="center">MID TERM RESULT</h4>
...
<th colspan="3" ></th>
<td style="padding-bottom:10px; font-size:12px; font-weight:bold" colspan="4">School Resumes : June. 6, 2022</td>
</tr>
...
<td style="text-align:center; border: 1px solid #ccc;font-size:12px">Test I</td>
<td style="text-align:center; border: 1px solid #ccc;font-size:12px">Test II</td>
<td style="text-align:center; border: 1px solid #ccc;font-size:12px">Exam</td>
...
<td style="text-align:center; border: 1px solid #ccc;font-size:12px">First Term</td>
<td style="text-align:center; border: 1px solid #ccc;font-size:12px">Second Term</td>
<td style="text-align:center; border: 1px solid #ccc;font-size:12px">Session Avg.</td>
<td style="text-align:center; border: 1px solid #ccc;font-size:12px">Session Grade</td>
<td style="text-align:center; border: 1px solid #ccc;font-size:12px">Comment</td>
</tr>

<tr><td style="text-align:center; border: 1px solid #ccc;font-size:12px"></td>
<td style="text-align:center; border: 1px solid #ccc;font-size:12px; font-weight:bold" class="obtainable"  align="center">10</td>
<td  style="text-align:center; border: 1px solid #ccc;font-size:12px; font-weight:bold " class="obtainable" align="center">10</td>
<td style="text-align:center; border: 1px solid #ccc;font-size:12px; font-weight:bold" class="obtainable" align="center" >10</td>
<td style="text-align:center; border: 1px solid #ccc;font-size:12px; font-weight:bold" class="obtainable" align="center" >10</td>
<td  style="text-align:center; border: 1px solid #ccc;font-size:12px; font-weight:bold " class="obtainable" align="center">10</td>
<td style="text-align:center; border: 1px solid #ccc;font-size:12px; font-weight:bold" class="obtainable" align="center" >50</td>
...
<td style="text-align:center; border: 1px solid #ccc;font-size:12px"></td>
<td style="text-align:center; border: 1px solid #ccc;font-size:12px" class="obtainable"  align="center" >100</td>
<td style="text-align:center; border: 1px solid #ccc;font-size:12px" class="obtainable"  align="center" >100</td>
<td style="text-align:center; border: 1px solid #ccc;font-size:12px" class="obtainable"  align="center" >100</td>
<td style="text-align:center; border: 1px solid #ccc;font-size:12px" class="obtainable"  align="center" ></td>
<td style="text-align:center; border: 1px solid #ccc;font-size:12px"></td>
