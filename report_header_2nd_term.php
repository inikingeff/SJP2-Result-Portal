...
$content="";
$content .= '<table  style="width:1000px; border-collapse: collapse" ><tr ><td class="banner" style="width:200px"><img style="width:160px" src="' . $woocommerce_gift_coupon_logo_base64 . '"></td><td class="banner" style="width:550px;padding-left:50px" align="left"><h1>SAINT JOHN PAUL II COLLEGE</h1><h2 align="center">SHELTER AFRIQUE, UYO</h2><h3 align="center">SECOND TERM 2021/2022 ACADEMIC SESSION</h3><h4 align="center">SECOND TERM RESULT</h4>
...
<th colspan="3" ></th>
<td style="padding-bottom:10px; font-size:12px; font-weight:bold" colspan="4">School Resumes : April 25, 2022</td>
</tr>
