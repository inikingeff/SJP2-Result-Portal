...
//	echo"$subject_table";
	...
	$second_term = round(($classwork + $assignment + $test_1 + $test_2 + $exams  + $project )/$count);
...
<td style="text-align:center; border: 1px solid #ccc;font-size:12px">'.$second_term.'</td>
